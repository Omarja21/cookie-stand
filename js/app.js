...
// };
function CalculateConsumptionForArea(minCust, maxCust, avgCookiesCust){
...
let seattle= new CalculateConsumptionForArea(10,15,6.3);
console.log(seattle.fillCookiePerHour());